...
export type { RecordFeedbackInput, MappingMemoryEntry } from './actions/record-feedback.js';
export type { GetMemoryInput } from './actions/get-memory.js';

export async function registerSchemaBridgePiece() {
  const { createPiece, PieceCategory } = await import('@activepieces/pieces-framework');
